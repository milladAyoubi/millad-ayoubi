...
const Cta = () => {
  return (
    <section className="relative overflow-hidden" id="#contact">
      <video
        className="absolute opacity-10 top-0 left-0 z-[-1] object-cover w-full h-[800px]"
        autoPlay
        muted
        loop
      >
      ...
      <motion.div
        ...
        div
        className="container mx-auto relative z-10 flex items-center justify-center py-20 xl:py-24"
      >
        {/* text & illustration */}
        <div className="grid pt-12 xl:h-[480px] mb-6">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="subtitle text-center ">
              ✦ Let's Work Together and create something awesome! Drop me a line
          ...
          <div className="m-auto">
            ...
            <div className="flex flex-col gap-y-4   text-base xl:text-lg">
              ...
              <div className="flex items-center gap-x-8 ">
                ...
                <div>
                  <a href="mailto:Milladayoubi@gmail.com">
                    Milladayoubi@gmail.com
                  </a>
                </div>
              </div>
              {/* address */}
      ...
      <footer className="bg-white/70 backdrop-blur-md py-4">
